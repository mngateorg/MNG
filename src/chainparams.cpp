...
public:
	CMainParams() {
		...
		const char* pszTimestamp = "NOT BAD DAY FOR-GOOD=START=THIS-ONE 19s820938 SO GO";
		...
		vout.resize(1);
		vout[0].SetEmpty();
		CTransaction txNew(1, 1537966799, vin, vout, 0);
		genesis.vtx.push_back(txNew);
		genesis.hashPrevBlock = 0;
		genesis.hashMerkleRoot = genesis.BuildMerkleTree();
		genesis.nVersion = 1;
		genesis.nTime = 1537966799;
		genesis.nBits = 0x1e0ffff0;
		genesis.nNonce = 910004;
		...
		hashGenesisBlock = genesis.GetHash();
        	...
        	assert(genesis.hashMerkleRoot == uint256("0xcb414cf6f49f29ca33263685b33182c90522c15d28d4f2058b42dac38b4459eb"));
	        assert(hashGenesisBlock == uint256("0x00003b56bcd24711f01da0d5e330c9aa84df85edbd14c81c9926349bb54b2f816311"));
		...
		vSeeds.push_back(CDNSSeedData("0", "68.183.21.201"));
		vSeeds.push_back(CDNSSeedData("1", "68.183.21.200"));
