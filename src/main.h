...
static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 3.5 MNG per COIN
static const int64_t TARGET_SPACING = 60 * 4; // 2 min per Block (2 ÐPOW+POS)
static const int64_t TARGET_SPACING2 = 60 * 4; // 2 min per Block  (POW+POS)
