...
// Copyright (c) 2018 The MNGate developers
...
unsigned int nStakeMinAge = 3 * 60 * 60; // 3 hourы
...
const string strMessageMagic = "MNGate Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1) {
      ...
      nSubsidy = 50000 * COIN;
    } else if (nHeight > 5 && nHeight <= 11001){
      nSubsidy = 2.5 * COIN;
    } else if (nHeight > 11001 && nHeight <= 22001){
      nSubsidy = 2.1 * COIN;
    } else if (nHeight > 22001 && nHeight <= 44001){
      nSubsidy = 2.7 * COIN;
    } else if (nHeight > 44001 && nHeight <= 88001){
      nSubsidy = 5 * COIN;
    } else if (nHeight > 88001 && nHeight <= 176001){
      nSubsidy = 4.3 * COIN;
    } else if (nHeight > 176001 && nHeight <= 352001){
      nSubsidy = 3.2 * COIN;
    } else if (nHeight > 352001 && nHeight <= 704001){
      nSubsidy = 2.1 * COIN;
    } else if (nHeight > 704001){
      nSubsidy = 2 * COIN;
    } 
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (nBestHeight >= 270 && nBestHeight <= 11001) {
      nSubsidy = 11 * COIN;
    } else if (nBestHeight > 11001 && nBestHeight <= 22001){
      nSubsidy = 10 * COIN;
    } else if (nBestHeight > 22001 && nBestHeight <= 44001){
      nSubsidy = 9 * COIN;
    } else if (nBestHeight > 44001 && nBestHeight <= 88001){
      nSubsidy = 8 * COIN;
    } else if (nBestHeight > 88001 && nBestHeight <= 176001){
      nSubsidy = 8 * COIN;
    } else if (nBestHeight > 176001 && nBestHeight <= 352001){
      nSubsidy = 7 * COIN;
    } else if (nBestHeight > 352001 && nBestHeight <= 704001){
      nSubsidy = 6 * COIN;
    } else if (nBestHeight > 704001){
      nSubsidy = 5 * COIN;
    }
        ...
        if(MasternodePayments)
        {
            ...
            if(IsProofOfStake() && pindex != NULL){
                if(pindex->GetBlockHash() == hashPrevBlock){
                    ...
                    CMNGateAddress address2(address1);
